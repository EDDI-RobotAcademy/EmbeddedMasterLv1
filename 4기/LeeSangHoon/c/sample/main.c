...
void polymorphism_not_impl(void *nothing)
{
...
void recv_command_from_pc (void)
{
    ...
    dto = (data_transfer_object *)malloc(sizeof(data_transfer_object));
    dto->num = 7;
    dto->name = (char *)malloc(sizeof(char) * 10);
    strcpy(dto->name, "test");

    polymorphism_call_table[command](dto);
}
